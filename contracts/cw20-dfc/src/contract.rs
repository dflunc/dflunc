...
const CONTRACT_NAME: &str = "crates.io:cw20-dfc";
...
pub fn execute(
    ...
    match msg {
        ...
        ExecuteMsg::Mint { recipient, amount } => execute_mint(deps, env, info, recipient.clone(), amount),
...
//     execute_mint(deps, env, info, recipient.clone(), amount)?;
